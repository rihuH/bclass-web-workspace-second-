				...
				<div class="offset-lg-2 col-lg-8">
					<div class="card">
						<div class="card-header text-white"
							style="background-color: #52b1ff;">${ notice.noticeNo }번
							게시물 내용</div>
						<div class="card-body">
							...
							<div class="form-group">
								<label>작성자</label> <input type="text" class="form-control"
									name='writer' value="${ notice.noticeWriter }" readonly>
							</div>

							<div class="form-group">
								<label>제목</label> <input type="text" class="form-control"
									name='title' value="${ notice.noticeTitle }" readonly>
							</div>
							...
							<a class="btn" href="delete.notice?noticeNo=${ notice.noticeNo }"
