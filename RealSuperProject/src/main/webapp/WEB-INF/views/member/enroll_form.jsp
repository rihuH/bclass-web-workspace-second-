...
<body>
	...
	<div style="width: 80%; margin: auto; padding: 50px;">
		<form action="enroll.me" name="signup" id="signUpForm" method="post"
			...
			<table
				...
				<tr>
					<td style="text-align: left">
						<p>
							<strong>취미를 입력해주세요.</strong>&nbsp;&nbsp;&nbsp;<span id="hobbyChk"></span>
						</p>
					</td>
				</tr>
				<tr>
					<td id="hobby-wrap"><input type="checkbox" id="baseball"
						value="야구" name="interest">&nbsp;<label for="baseball">야구</label>
						<input type="checkbox" id="device" value="전자제품" name="interest">&nbsp;<label
						for="device">전자제품</label> <input type="checkbox" id="camping"
						value="캠핑" name="interest">&nbsp;<label for="camping">캠핑</label> <br>

						<input type="checkbox" id="farming" value="농사" name="interest">&nbsp;<label
						for="farming">농사</label> <input type="checkbox" id="web"
						value="web" name="interest">&nbsp;<label for="tea">웹</label> <input
						type="checkbox" id="java" value="자바" name="interest">&nbsp;<label
