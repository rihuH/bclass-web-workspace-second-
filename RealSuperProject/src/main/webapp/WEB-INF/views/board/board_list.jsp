...
<div class="container">
				...
				<table class="table table-bordered table-hover">
					...
					<c:forEach items="${ list }" var="board">
						<tr style="color: #52b1ff;" class="board" id="${ board.boardNo }">
							...
							<td style="color: #52d6ffcc;" onclick="location.href='detail.board?boardNo=${board.boardNo}'">${board.boardTitle } &nbsp;</td>
	...
	<div class="paging-area" align="center">
		...
		<c:if test="${ pi.endPage ne maxPage }">
		<button class="btn btn-outline-primary" style="color: #52b1ff;"
			onclick="location.href='list.board?currentPage=${pi.endPage + 1}'">다음</button>
		</c:if>
	</div>
