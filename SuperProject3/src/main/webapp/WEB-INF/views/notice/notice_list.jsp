   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-10">
            ...
            <h2 class="page-header"><span style="color: #52b1ff;">KH</span> 공지사항 게시판
            <c:if test="${ loginUser.userNo eq 1 }">
               <a href="enrollForm.notice" class="btn float-right" style="background-color: #52b1ff; margin-top: 0; height: 40px; color: white; border: 0px solid #f78f24; opacity: 0.8">글쓰기</a>
            </c:if>
            </h2>
               <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr style="color: #52b1ff;"
                        ...
                        <a href="detail.notice?noticeNo=${ n.noticeNo }">
                        ${ n.noticeTitle } &nbsp;
                        </td>
                        <td>
                        ${ n.createDate }
